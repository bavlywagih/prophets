                ...
                @auth
                    <div class="btn-group  ">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item text-end" href="{{ route('Setting' , Auth()->user()->id) }}">{{ trans('navbar/navbar_trans.settings') }}</a></li>
                            <li><hr class="dropdown-divider"></li>
            ...
            <div>
                ...
                @auth
                    <div class="d-block d-md-none">
                        <a href="{{$profile}}" class="nav-menu-item d-flex flex-row-reverse d-flex align-items-center "><div class="ps-3"></div>{{$AuthName}}</a>
                    </div>
                @else    
                ...
                <a href="{{ $users }}" class="nav-menu-item d-flex flex-row-reverse d-flex align-items-center "><div class="ps-3"><i class="fa-solid fa-users-gear me-3"></i></div> {{ trans('navbar/navbar_trans.users') }}</a>
                ...
                <div class="d-block d-md-none">
                    ...
                    @endguest
                    @auth
                    <a href="{{$profile}}" class="nav-menu-item d-flex flex-row-reverse d-flex align-items-center"> <div class="ps-3"> <i class="fa-solid fa-address-card"></i> </div> {{ trans('navbar/navbar_trans.profile') }}</a>
