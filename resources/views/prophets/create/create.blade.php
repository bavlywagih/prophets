        ...
        <div class="card-body">
            ...
            <form action="{{ route('Prophets_create_post') }}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="d-flex flex-row-reverse div-setting-ltr">
                        <div class="w-25 text-end text-start-setting-ltr">
                            <h6 class="mb-0"> {{ trans('Prophets/create.type') }} </h6>
                        </div>
                        <div class="mb-3 w-75">
                            <select class="form-select type_rtl" name="type" aria-label="Default select example">
                                <option  selected value="0">{{ trans('Prophets/create.prophet') }}</option>
                                <option value="1">{{ trans('Prophets/create.prophetess') }}</option>
