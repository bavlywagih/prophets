            ...
            <form action="{{route('Setting_update')}}" method="POST">
                ...
                <div class="card-body">
                    <div class="d-flex flex-row-reverse justify-content-around div-setting-ltr">
                        ...
                        <div class=" text-secondary   w-75 text-end">
                                <input type="text" name="name_arabic" value="{{ trans('setting/setting_trans.name_arabic') }}" class="form-control text-start-setting-ltr input-end-setting-rtl" placeholder="{{ trans('setting/setting_trans.name_arabic') }}" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex flex-row-reverse justify-content-around div-setting-ltr">
                        ...
                        <div class=" text-secondary   w-75 text-end">
                                <input type="text" name="name" value="{{ trans('setting/setting_trans.name') }}" class="form-control text-start-setting-ltr input-end-setting-rtl" placeholder="{{ trans('setting/setting_trans.name') }}" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                </div>
